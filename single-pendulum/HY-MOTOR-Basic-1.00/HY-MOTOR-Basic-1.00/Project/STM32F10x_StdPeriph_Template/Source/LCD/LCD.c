...
//#define LCD_RAM              (*((volatile unsigned short *) 0x6C000002)) /* RS = 1  A2 */
#define LCD_REG              (*((volatile unsigned short *) 0x60000000)) /* RS = 0  */
#define LCD_RAM              (*((volatile unsigned short *) 0x60020000)) /* RS = 1  A16*/
...
static void LCD_FSMCConfig(void)
{
	...
	FSMC_NORSRAMInitStructure.FSMC_Bank = FSMC_Bank1_NORSRAM1;  //FSMC_Bank2_NAND;
	FSMC_NORSRAMInitStructure.FSMC_DataAddressMux = FSMC_DataAddressMux_Disable;//Disable;
	FSMC_NORSRAMInitStructure.FSMC_MemoryType = FSMC_MemoryType_SRAM;     //类型 FSMC_MemoryType_NOR  FSMC_MemoryType_SRAM
	...
	/* FSMC写速度设置 */
	FSMC_NORSRAMTimingInitStructure.FSMC_AddressSetupTime = 15;//5;   /* 地址建立时间  */
	FSMC_NORSRAMTimingInitStructure.FSMC_AddressHoldTime = 10; //0	   
	FSMC_NORSRAMTimingInitStructure.FSMC_DataSetupTime = 10;//10;	   /* 数据建立时间  */
	FSMC_NORSRAMTimingInitStructure.FSMC_BusTurnAroundDuration = 0x00;
	FSMC_NORSRAMTimingInitStructure.FSMC_CLKDivision = 0x00;
	FSMC_NORSRAMTimingInitStructure.FSMC_DataLatency = 0x00;
	FSMC_NORSRAMTimingInitStructure.FSMC_AccessMode = FSMC_AccessMode_A;	/* FSMC 访问模式 */
...
void LCD_Initializtion(void)
{
  ...
  //DeviceCode = 0x9325;  
	...
	/* 不同屏驱动IC 初始化不同 */
	//if( DeviceCode == 0x9324 || DeviceCode == 0x9325 || DeviceCode == 0x9328 )	
