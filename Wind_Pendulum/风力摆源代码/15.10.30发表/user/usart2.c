...
//	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD, ENABLE);
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD | RCC_APB2Periph_AFIO,ENABLE);//开启端口D和复用功能时钟
 ...
 */
static char *itoa2(int value, char *string, int radix)
{
    int     i, d;
    int     flag = 0;
    char    *ptr = string;
...
{
	sprintf(buf,"CLS(0);DS16(6,02,'2015全国大学生电子设计竞赛',10);DS16(54,22,'风力摆控制系统',2);\r\n");//清屏函数；
	GpuSend(buf);
}
